...
## which is really a list (dataframe?) containing a function to:
## 1) set the value of the matrix, 
## 2) get the value of the matrix, 3) set the inverse of the matrix "x", and
...
## The following function "cacheinverse" calculates the inverse
